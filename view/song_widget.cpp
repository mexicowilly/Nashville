...
// SongHeaderWidget
// ---------------------------------------------------------------------------
SongHeaderWidget::SongHeaderWidget(const model::song& song, QWidget* parent)
...
void SongHeaderWidget::paintEvent(QPaintEvent*)
{
...
// SongWidget
// ---------------------------------------------------------------------------
SongWidget::SongWidget(const model::song& song, QWidget* parent)
    : QWidget(parent), song_(song)
{
    ...
    header_ = new SongHeaderWidget(song_, this);
    ...
    body_ = new SongBodyWidget(song_, scroll_);
...
void SongWidget::refresh()
{
    header_->update();
    body_->rebuild();
}

void SongWidget::print(QPrinter* printer)
{
    ...
    body_->paintToRect(painter, bodyRect);
}
